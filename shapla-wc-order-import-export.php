...
final class ShaplaWCOrderImportExport {
	...
	public function register_importers() {
		if ( defined( 'WP_LOAD_IMPORTERS' ) ) {
			...
			register_importer( 'woocommerce_order_json', __( 'WooCommerce orders (JSON)', 'woocommerce' ),
				__( 'Import <strong>orders</strong> to your store via a json file.', 'woocommerce' ),
 ...
 */
add_action( 'plugins_loaded', [ ShaplaWCOrderImportExport::class, 'get_instance' ] );
